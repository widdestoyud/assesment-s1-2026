export default {
  ...
  mbc_station_max_remaining_info: 'Maximum top-up: Rp {{remaining}}',
  ...
  mbc_role_picker_select_button: 'Select',
  ...
  mbc_role_picker_nfc_ready: 'NFC card ready to use',
  mbc_role_picker_nfc_unavailable: 'NFC not available on this device',
  mbc_role_picker_nfc_pending: 'Waiting for NFC permission...',
  ...
  mbc_role_station_description_long: 'Manage balance, top-up, and member registration',
  mbc_role_scout_label: 'The Scout',
  mbc_role_scout_subtitle: 'Pocket Book',
  mbc_role_scout_description: 'Pocket Book',
  mbc_role_scout_description_long: 'View information, history, and member benefits',
